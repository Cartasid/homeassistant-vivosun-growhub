...
SHADOW_KEY_DEHUMIDIFIER = "dhmdf"
SHADOW_KEY_HEATER = "heat"
SHADOW_KEY_AIR_CONDITIONER = "aircd"
...
SENSOR_KEY_BOX_TEMP = "bTemp"
SENSOR_KEY_BOX_HUMI = "bHumi"
SENSOR_KEY_BOX_VPD = "bVpd"
...
# AeroLush C08 air conditioner operating functions and fan levels.
AIRCD_FUNC_COOL = 1
AIRCD_FUNC_HEAT = 2
AIRCD_FUNC_DRY = 3
AIRCD_FUNC_FAN = 4
AIRCD_FAN_QUIET = 50
AIRCD_FAN_STANDARD = 100
