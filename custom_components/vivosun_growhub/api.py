...
class VivosunApiClient:
    ...
    async def _request_json(
        ...
        *,
        ...
        if json_body is not None:
            ...
            # Login is the only POST that remains plaintext; production
            # authenticated POST endpoints now require app-compatible wrapping.
    ...
    def _base_headers(self) -> dict[str, str]:
        """Headers the official app sends on every request."""
        return {
